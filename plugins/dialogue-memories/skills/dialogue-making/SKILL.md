---
name: dialogue-making
description: Turn conversations, creative notes, and work records into a making-of story or a behind-the-scenes article about a work or project. Use to trace an idea, experiments, doubts, and decisions. Not a substitute for routine progress reports or operating instructions.
---
...
Choose between listening and writing according to the available material and the person's interests. Invite their recollections, and draft when the decisions come into view. Receive the memories and corrections a draft brings out, and grow the piece to the point the person wants to bring together.
...
Check important chronology, outcomes, and publication status against available records. Without records, treat the material as the maker's recollection; please do not invent corroboration or unreported inner thoughts. Keep tentative ideas distinct from finished specifications, prototypes from published work, and self-checks from independent evaluations. Limit unresolved questions to the parts they affect.

A request to write is separate from permission to publish or send. Please do not automatically append production chats or work logs as public supporting material. Before introducing them, check their usefulness to readers and whether sharing them is appropriate for participants, then choose the relevant scope. A note saying unrelated material is included does not replace that check.
